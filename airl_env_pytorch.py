...
print(hpccm.primitives.baseimage(image='nvidia/cuda:11.3.0-cudnn8-devel-ubuntu20.04', _docker_env=False))
print(hpccm.primitives.label(metadata={'Author': 'luca.grillotti16@imperial.ac.uk', 'Version': 'v2.3'}))
